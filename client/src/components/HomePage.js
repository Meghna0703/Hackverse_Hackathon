...
Our aim is to provide relevant information about diseases and treatments and expanding physician’s ability to care for patients in a quick and accurate manner.
        ...
        <div className="serviceContainer">
              ...
              <div className='cardContainer'>
                 ...
                 <h5 style={{fontSize:'18px',color:'#F49F0A'}} className="heading">Specialist Doctor Consultancy</h5>
                  <p>This section on the website can be used to consult to the specialist doctor as per the diagnosed disease .
                  </p>
                 </div>
              </div>
